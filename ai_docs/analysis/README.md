...
| Document | What it is |
|---|---|
| [`evaluation_gaps.md`](evaluation_gaps.md) | 13 opportunities to broaden v1's / the paper's test & evaluation coverage (filesystem fixtures, content types, evaluation methodology), split into gaps the authors don't discuss vs. gaps they already flag themselves. |
