...
```text
==================================================================
 caruca_v2 dev template: Worktree
...
```bash
PROJECT_ROOT=$(pwd)                    # e.g., /Users/dev/projects/worker-simple
PROJECT_NAME=$(basename "$PROJECT_ROOT") # e.g., worker-simple
PARENT_DIR=$(dirname "$PROJECT_ROOT")    # e.g., /Users/dev/projects
WORKTREE_DIR="${PARENT_DIR}/${PROJECT_NAME}-{name}"  # e.g., /Users/dev/projects/worker-simple-auth
```

**Examples:**
- `/worktree auth` → Folder: `../worker-simple-auth/`, Branch: `feat/auth`
- `/worktree fix-upload` → Folder: `../worker-simple-fix-upload/`, Branch: `fix/fix-upload`
- `/worktree list` → Shows all worktrees
- `/worktree remove auth` → Removes `../worker-simple-auth/` worktree
...
|-----------|--------|--------|
| /path/to/worker-simple | main | (main worktree) |
| /path/to/worker-simple-auth | feat/auth | active |
| /path/to/worker-simple-bugfix | fix/bugfix | active |
```
...
|---|-----------|--------|---------|
| 1 | .../worker-simple | main | Main development |
| 2 | .../worker-simple-auth | feat/auth | Feature: Authentication |
| 3 | .../worker-simple-bugfix | fix/bugfix | Bugfix |
