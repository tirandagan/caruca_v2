---
description: "Generate Beautiful Landing Page Template"
---
...
```text
==================================================================
 caruca_v2 command: Generate landing page
...
* `app/global.css` - Tailwind v4 theme implementation with `@theme` directive, CSS variables, and custom styles
...
* Review `app/globals.css` for existing theme variables (Tailwind v4 uses CSS-first configuration)
